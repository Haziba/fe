...
var uri = require('url')
  ...
  , util = require('util')
  , OAuth2Strategy = require('../../passport-oauth2/lib/index.js')
  , Profile = require('./profile')
  , InternalOAuthError = require('../../passport-oauth2/lib/index.js').InternalOAuthError
...
Strategy.prototype.authenticate = function(req, options) {
  ...
  if (req.query && req.query.error_code && !req.query.error) {
    console.log('error here!!!', req.query.error_message);
